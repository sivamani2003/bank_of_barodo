...
const Team = ({ isDarkMode }) => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      github: 'https://github.com/silenetokyo',
      twitter: 'https://twitter.com/silenetokyo',
      instagram: 'https://instagram.com/silenetokyo'
    },
    {
      img: img3,
      name: 'Johnson Stone',
    ...
    },
    {
      ...
      name: 'Another Member',
      title: 'Another Role',
      description: 'Description for another member of the team.',
      github: 'https://github.com/anothermember',
      twitter: 'https://twitter.com/anothermember',
      instagram: 'https://instagram.com/anothermember'
    }
  ];
  ...
  const handleNext = () => {
    ...
    return (
        ...
        <><div className="container mx-auto pt-3 text-center">
            ...
            </div><div className={w - full} px-10 $ {...isDarkMode ? 'bg-gray-800 text-white' : 'bg-white'}>
